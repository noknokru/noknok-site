...
.hero-img { position: absolute; z-index: 1; top: 50%; left: 50%; transform: translate(-50%, -50%); height: 62vh; width: auto; pointer-events: none; }
.hero-content { position: absolute; z-index: 2; top: 100px; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 18px; max-width: 450px; padding: 0; }
